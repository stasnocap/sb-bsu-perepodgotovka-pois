//
// Created by КапитанС on 12/22/2023.
//

#ifndef TASK_4_1_3_ВЕ_КРЕСТ_КРЕСТ_H
#define TASK_4_1_3_ВЕ_КРЕСТ_КРЕСТ_H
...
#define приказ_княжий_исполнить constexpr
#define мощь pow
#define получи_басурман throw
#define гнев_Перуна exception
#define гнев_Перуна_други invalid_argument
...
внедрить много_букав_увидеть = Русь::string_view;
...
#endif //TASK_4_1_3_ВЕ_КРЕСТ_КРЕСТ_H
